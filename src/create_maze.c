 ...
 **/
void plot_grid_points(char **maze, double_axis *play, int_axis *win, size_t cur_char,
 ...
 **/
char **create_map(char *file_string, double_axis *play, int_axis *win, size_t *map_h)
{
	FILE *maze_file;
	char **maze, *line = NULL;
	ssize_t read = 0;
